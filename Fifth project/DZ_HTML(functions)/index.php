...
<head>
    ...
    <!-- Подключаем CSS -->
    <link rel="stylesheet" href="../DZ_HTML(functions)/css/style.css"/>
    <!-- Кодировка страницы -->
    <meta charset="UTF-8">
</head>
            ...
            <div class="content3">
                ...
                <div class="conten32">
                    <div class="content_text">
                        ...
                        <?php
                        $first = "<p>Меня зовут, Юра, мне 35лет. Работаю на ММК ООО МРК плавильщиком 
...
читать книги из последнего начал читать Граф Монте-Кристо (А. Дюма), когда получается люблю проводить время активно и с пользой.</p>";
                        function par($firstSentence)
                        {
                            ...
                            $change=file_get_contents('test.txt');
                            echo str_replace([$array[0]], ["<b>" . "$change" . "</b>"], $firstSentence);
                        }
                ...
                <div class="content33">
                    <div class="content_text">
                        ...
                        $arraySecond = explode(' ', $color);

                        function text($color, $arraySecond) {
