            ...
            <nav class="navigation flex">
                ...
                <form class="lights flex" name="color">                    
                    ...
                    <div class="__select__content" id="none">
                        ...
                        <label for="singleSelect2" class="__select__label">Бело-синяя</label>
                        <input id="singleSelect3" class="__select__input" type="radio" name="color" value="green" />
                        <label for="singleSelect3" class="__select__label">Зелёно-фиолетовая</label>
                        <input id="singleSelect4" class="__select__input" type="radio" name="color" value="red" />
                        <label for="singleSelect4" class="__select__label">Красно-золотая</label>
                        </div>
                    </div>
